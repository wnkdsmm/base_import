...
from tests.case_runners import clustering_math_quality_cases_legacy as legacy
...
def run_clustering_case(case: dict[str, str]) -> None:
...
def test_clustering_case(clustering_case: dict[str, str]) -> None:
    run_clustering_case(clustering_case)
