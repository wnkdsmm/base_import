...
def _serialize_count_comparison_row(row: CountComparisonRow) -> Dict[str, Any]:
    return {
        ...
        'mae_delta_vs_baseline': row.mae_delta_vs_baseline,
        'rmse_delta_vs_baseline': row.rmse_delta_vs_baseline,
        'smape_delta_vs_baseline': row.smape_delta_vs_baseline,
    }
...
def _assemble_training_result(
    *,
    ...
    return {
        ...
        'brier_score': event_metrics.brier_score,
        'baseline_brier_score': event_metrics.baseline_brier_score,
        'heuristic_brier_score': event_metrics.heuristic_brier_score,
        'roc_auc': event_metrics.roc_auc,
        'baseline_roc_auc': event_metrics.baseline_roc_auc,
        'heuristic_roc_auc': event_metrics.heuristic_roc_auc,
        'f1_score': event_metrics.f1,
        'baseline_f1_score': event_metrics.baseline_f1,
        'heuristic_f1_score': event_metrics.heuristic_f1,
        'log_loss': event_metrics.log_loss,
        'baseline_log_loss': event_metrics.baseline_log_loss,
        'heuristic_log_loss': event_metrics.heuristic_log_loss,
        'count_comparison_rows': [
